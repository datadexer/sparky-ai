    ...
    steps = [
        Step(
            ...
            prompt=(
                ...
                "  import numpy as np\n"
                "  # WARNING: Synthesising Gaussian returns from a Sharpe ratio and then computing\n"
                "  # DSR is statistically circular — the DSR reflects the assumed distribution, not\n"
                "  # the actual strategy returns. Use this ONLY as a rough approximation when real\n"
                "  # returns are unavailable. Flag the result as 'approximate DSR' in the report.\n"
                "  T = 8760 * 5\n"
                "  np.random.seed(42)\n"
