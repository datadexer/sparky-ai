...
def validate_ensemble(features, target, prices_daily):
    ...
    for year in years:
        ...
        for cfg in TOP3_CONFIGS:
            model = CatBoostClassifier(iterations=200, **cfg, task_type="GPU", devices="0", verbose=0, random_state=42)
        ...
        print(
            f"{year}: Sharpe={sharpe:6.2f}, Acc={acc:.3f}, MaxDD={metrics['max_dd']:.2%}, "
