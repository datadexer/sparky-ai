...
def main():
    ...
    for i, config in enumerate(configs):
        ...
        result = yearly_walk_forward_validation(
            features, target, prices,
    ...
    print(f"Best config: {summary['best_config']['model_name']} with Mean Sharpe {summary['best_config']['mean_sharpe']:.3f}")
